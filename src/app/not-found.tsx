            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  Parece que la página que buscabas ha sido trasladada, eliminada o no existe.
                </p>
                <Link
                  href="/"
                  className="px-8 py-3 text-base font-bold text-white duration-300 rounded-md bg-navy shadow-signUp hover:bg-white hover:text-navy/90 md:px-9 lg:px-8 xl:px-9"
                >
