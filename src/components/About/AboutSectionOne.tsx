              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Código Limpio y Mantenible" />
                    <List text="Arquitectura Escalable" />
                    <List text="Seguridad por Diseño" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Entrega Continua" />
                    <List text="Documentación Técnica" />
                    <List text="Soporte Post-Lanzamiento" />
                  </div>
                </div>
              </div>
            </div>
